<template>
  <div class="container">
    <div
      class="p-16 sm:p-0 w-full mx-auto flex justify-between items-center bg-white wrapper"
    >
      ...
      <div class="lg:w-1/3 flex flex-wrap justify-center flex-grow">
        ...
        >
          <h1 v-html="heroBanner.acf.Header"></h1>
        </h1>

        <div class="w-full text-center mt-16">
          <p class="subtitle font-normal">{{ heroBanner.acf.subtitle }}</p>
        </div>
        <router-link to="/">
          <div class="ctaButton mt-16">
            {{
              heroBanner && heroBanner.acf && heroBanner.acf.button_text
                ? heroBanner.acf.button_text
                : "oeps"
            }}
          </div>
        </router-link>
